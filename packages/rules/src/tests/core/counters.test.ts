...
export function testUnboundedCountersExceedCommonChargeLimits() {
  ...
  chikatilo = setCharges(chikatilo, ABILITY_CHIKATILO_DECOY, 11);
  chikatilo = addCharges(chikatilo, ABILITY_CHIKATILO_DECOY, 8);
  ...
  assert.strictEqual(getChargeLimit(ABILITY_CHIKATILO_DECOY), null);
  ...
  assert.strictEqual(getCharges(chikatilo, ABILITY_CHIKATILO_DECOY), 19);

...
export const ABILITY_SPECS_PART_4: Record<string, AbilitySpec> = {
  ...
  [ids.ABILITY_DUOLINGO_PUSH_NOTIFICATION]: {
    ...
    kind: "active",
    description: "Its own counter gains +1 at the start of Duolingo's turn. At 3, spend that counter without Movement, or instead spend 3 Missed Lessons and Movement. Choose a living creature, then teleport to a legal empty cell within 2 cells of it. Exit stealth.",
    maxCharges: 3,
    chargesPerUse: 3,
  ...
  [ids.ABILITY_LUCHE_DIVINE_RAY]: {
    ...
    kind: "impulse",
    description: "Its own counter gains +1 at the start of Luche's turn. At 2, spend that counter to choose a straight attack line without Sun or Action. It may instead spend 2 Sun and Action. Attack every enemy on the line; failed defenses apply Blind until that enemy's next turn.",
    maxCharges: 2,
    chargesPerUse: 2,
  ...
  [ids.ABILITY_ZORO_ONI_GIRI]: {
    ...
    kind: "active",
    description: "Its own counter gains +1 at the start of Zoro's turn. At 2, spend that counter to use Oni Giri without Determination, Action, or Movement. It may instead spend 2 Determination, Action, and Movement. Choose an enemy on a straight line, move directly before or behind it, then attack it.",
    maxCharges: 2,
    chargesPerUse: 2,

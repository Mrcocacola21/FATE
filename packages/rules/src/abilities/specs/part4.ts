...
export const ABILITY_SPECS_PART_4: Record<string, AbilitySpec> = {
  ...
  [ids.ABILITY_DUOLINGO_PUSH_NOTIFICATION]: {
    ...
    kind: "active",
    description: "Spend 3 Missed Lessons and Movement: choose a living creature, then teleport to a legal empty cell within 2 cells of it. Exit stealth.",
  ...
  [ids.ABILITY_LUCHE_DIVINE_RAY]: {
    ...
    kind: "impulse",
    description: "Its own counter gains +1 at the start of Luche's turn. At 2, choose a straight attack line as a free impulse. During Luche's turn, it may instead spend 2 Sun and Action. Attack every enemy on the line; failed defenses apply Blind until that enemy's next turn.",
    maxCharges: 2,
    chargesPerUse: 2,
  ...
  [ids.ABILITY_ZORO_ONI_GIRI]: {
    ...
    kind: "active",
    description: "Its own counter gains +1 at the start of Zoro's turn. At 2, use it as a free start-turn impulse. During Zoro's turn, spend 2 Determination, Action, and Movement. Choose an enemy on a straight line, move directly before or behind it, then attack it.",
    maxCharges: 2,
    chargesPerUse: 2,

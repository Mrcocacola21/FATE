...
const FRISK_ART = new URL("./figures/frisk.webp", import.meta.url).href;
...
const LOKI_ART = new URL("./figures/loki.webp", import.meta.url).href;
...
const FRISK_TOKEN = new URL("./tokens/frisk.webp", import.meta.url).href;
...
const LOKI_TOKEN = new URL("./tokens/loki.webp", import.meta.url).href;
const ODIN_TOKEN = new URL("./tokens/odin.webp", import.meta.url).href;

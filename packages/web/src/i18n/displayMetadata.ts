...
const abilitiesUk: Record<string, AbilityTranslation> = {
  ...
  lucheShine: { name: "Сяйво", description: "Сяйво — пасивна. Коли фігура успішно влучає по Луче, ця фігура стає Осліпленою до кінця свого наступного ходу." },
  lucheDivineRay: { name: "Промінь світла", description: "Власний лічильник отримує +1 на початку ходу Луче. На 2 спрацьовує безкоштовний імпульс. Під час ходу можна натомість витратити 2 Сонця й основну дію. Оберіть пряму лінію або область навколо Луче; невдалий захист накладає Осліплення до кінця наступного ходу цілі." },
  ...
  jackRipperCoveringTracks: { name: "Заметання слідів", description: "Пасивна. Якщо Джек має поставити шостий силок, коли на полі вже є 5 силків, оберіть один наявний силок і підірвіть його. Істоти в радіусі 1 кидають 1d6; на 1–4 отримують 1 шкоди, на 5–6 уникають її." },

...
const abilitiesUk: Record<string, AbilityTranslation> = {
  ...
  kaiserBunker: {
    name: "Бункер",
    description: "Замість скритності може увійти в бункер на 4–6. Позицію видно, а влучання завдають 1 шкоди.",
  },
  kaiserDora: {
    name: "Дора",
    description: "З бункера оберіть область 3×3 із центром на лінії атаки та атакуйте всі фігури в ній.",
  },
  kaiserCarpetStrike: {
    name: "Килимовий удар",
    description: "Визначає центр області 5×5 і атакує всіх у ній. Завжди завдає 1 шкоди; Кайзер у бункері не страждає.",
  },
  kaiserEngineeringMiracle: {
    name: "Інженерне диво",
    description: "Надає класи вершника й берсерка та безкоштовну «Дору», але вимикає скритність і бункер.",
  },
  vladPolkovodets: {
    name: "Полководець",
    description: "Союзники в сусідніх клітинках отримують +1 до шкоди. Ефект не діє на власника й не складається.",
  },
  vladIntimidate: {
  ...
  groznyTyrant: {
    name: "Тиран",
    description: "Може добити ослабленого союзника, відновити здоров’я, посилити шкоду й отримати додаткові переміщення.",
  },
  chikatiloTough: { name: "Живучий", description: "+1 до максимального здоров’я." },
  chikatiloFalseTrail: {
    name: "Хибний слід",
    description: "На початку бою замінюється жетоном і приховано розміщується будь-де. Розкриття запускає вибір долі жетона.",
  },
  chikatiloAssassinMark: {
    name: "Мітка вбивці",
    description: "Не виходячи зі скритності, позначте ціль у радіусі 2. Влучання по ній отримує +1 шкоди.",
  },
  chikatiloDecoy: {
    name: "Приманка",
    description: "Витратьте 3 заряди, щоб увійти в скритність без кидка або перед захистом отримати рівно 1 шкоду.",
  },
  falseTrailTrap: {
    name: "Пастка хибного сліду",
    description: "Коли жетон гине або Чикатило розкривається, пастка може завдати викривачу 3 шкоди.",
  },
  falseTrailExplosion: {
    name: "Вибух",
  ...
  elCidCompeadorDemonDuelist: {
    name: "Демон-дуелянт",
    description: "Послідовно атакує обрану ціль, доки атаки успішні. Після промаху можна сплатити 1 здоров’я й продовжити.",
  },
  ...
  lechyGuideTraveler: {
    ...
    description: "Оберіть союзника в радіусі трикстера, перемістіть Лісовика й перенесіть союзника до його нової позиції.",
  },
  lechyConfuseTerrain: {
  ...
  lechyStorm: {
    name: "Буря",
    description: "Замінює арену бурею: фігури поза лісом ризикують отримати шкоду та втрачають дальні атаки.",
  },
  griffithWretchedMan: {
  ...
  femtoGodHp: { name: "Бог", description: "Фемто отримує +5 здоров’я понад базове здоров’я берсерка." },
  femtoMultiBerserkSpear: {
    name: "Мультиклас: берсерк і списник",
    description: "Поєднує основу берсерка, дальність і захист списника та автоматичне влучання лицаря на дублях.",
  },
  femtoDivineMove: {
  ...
  gutsCannon: { name: "Ручна гармата", description: "Дальня атака за правилами лучника зі звичайною шкодою." },
  gutsBerserkMode: {
    name: "Режим берсерка",
    description: "Витрачає 3 заряди: посилює ближній бій і змінює правила шкоди, але завдає шкоди наприкінці ходу.",
  },
  gutsExitBerserk: {
    name: "Вийти з режиму берсерка",
    description: "Раз за гру завершує режим берсерка й витрачає дію.",
  },
  odinGungnir: { name: "Ґунґнір", description: "Дублі на кидку атаки стають автоматичними влучаннями." },
  odinHuginn: {
    name: "Ворон Гуґінн",
  ...
  odinMuninn: {
    name: "Ворон Мунінн",
    description: "Після кидка захисту можна витратити 6 зарядів і перетворити його на автоматичний успіх.",
  },
  odinSleipnir: {
    name: "Слейпнір",
    description: "За 3 заряди телепортує на будь-яку вільну клітинку без витрати переміщення чи дії.",
  },
  lokiIllusoryDouble: {
  ...
  jebeHailOfArrows: {
    name: "Град стріл",
    description: "Оберіть область 3×3 із центром на лінії атаки лучника та атакуйте всі фігури в ній.",
  },
  jebeKhansShooter: {
    name: "Стрілець хана",
    description: "Витрачає 6 зарядів, визначає кількість рикошетів і послідовно атакує обрані легальні цілі.",
  },
  ...
  kaladinFourth: { name: "Четверта клятва — Клятва обмеження", description: "Надає набір властивостей берсерка." },
  kaladinFifth: {
  ...
  friskCleanSoul: {
    name: "Чиста душа",
    description: "Якщо Фріск виходить зі скритності без атаки, наступна ворожа атака автоматично промахується.",
  },
  friskOnePath: {
    name: "Один шлях",
  ...
  sansBadassJoke: {
    name: "Крутий жарт",
    description: "За 3 заряди атакує ворогів у зоні трикстера; невдалий захист блокує їхнє наступне переміщення.",
  },
  sansSpearmanFeature: { name: "Властивість списника", description: "Дубль у захисті дає автоматичне ухилення." },
  sansUnbeliever: {
  ...
  sansSleep: { name: "Сон", description: "Після перетворення витрачає 3 заряди й відновлює Сансу 2 здоров’я." },
  sansLastAttack: {
    name: "Остання атака",
    description: "Після смерті Санса проклинає ворога: той втрачає 1 здоров’я на початку ходу, доки не лишиться 1.",
  },
  ...
  undyneUndying: {
    ...
    description: "Раз за гру воскресає з 3 здоров’я, обмежує вхідну шкоду до 1 й отримує бойові бонуси.",
  },
  asgoreFireball: { name: "Вогняна куля", description: "Дальня атака по одній цілі за правилами лучника." },
  asgoreFireParade: {
    name: "Вогняний парад",
  ...
  papyrusBlueBone: {
    name: "Синя кістка",
    description: "Влучання накладає Синю кістку: витрата переміщення цього ходу одразу завдає 1 шкоди.",
  },
  papyrusSpaghetti: { name: "Смачні спагеті", description: "За 3 заряди відновлює Папірусу 2 здоров’я." },
  papyrusCoolGuy: {
    name: "Крутий хлопець",
  ...
  papyrusUnbeliever: {
    ...
    description: "Після смерті союзника назавжди відкриває Помаранчеву й Довгу кістки та Скам’яніння.",
  },
  papyrusOrangeBone: {
    name: "Помаранчева кістка",
    description: "Після перетворення замінює Синю кістку й карає ціль, що завершила хід без переміщення.",
  },
  papyrusLongBone: {
    name: "Довга кістка",
    description: "Після перетворення дозволяє зробити базову атаку лінійною та зберігає вибрану вісь.",
  },
  papyrusOssified: {
    name: "Скам’яніння",
    description: "Після перетворення Папірус отримує автозахист берсерка.",
  },
  mettatonLongLiver: { name: "Довгожитель", description: "Меттатон отримує +2 до максимального здоров’я." },
  mettatonRating: {
    name: "Рейтинг",
  ...
  mettatonFinalChord: {
    ...
    description: "За 12 рейтингу атакує всіх ворогів на всіх доступних лініях і завдає 3 шкоди при влучанні.",
  },
  riverBoat: {
    name: "Човен",
    description: "Під час переміщення може взяти сусіднього союзника й висадити його біля кінцевої клітинки.",
  },
  riverBoatman: {
    name: "Човняр",
    description: "Витрачає дію, щоб переміститися без витрати комірки переміщення.",
  },
  riverGuideOfSouls: {
    name: "Провідник душ",
  ...
  riverTraLaLa: {
    name: "Тра-ля-ля",
    description: "За 4 заряди рухається по прямій, а союзники на шляху по одному разу атакують обраного ворога.",
  },
};
...
export function getHeroDisplayName(id: string | null | undefined, fallback: string, language: Language) {

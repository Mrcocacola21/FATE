...
const abilitiesUk: Record<string, AbilityTranslation> = {
  ...
  duolingoPushNotification: { name: "Push-сповіщення", description: "Власний лічильник отримує +1 на початку ходу Дуелінго. За 3 заряди витратьте лише цей лічильник або натомість витратьте 3 Пропущені уроки й дію руху: перемістіться на вільну клітинку в радіусі 2 від обраної живої істоти." },

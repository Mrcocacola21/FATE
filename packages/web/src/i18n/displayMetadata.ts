...
const abilitiesUk: Record<string, AbilityTranslation> = {
  ...
  riverBoat: {
    name: "Човен",
    description:
      "Під час переміщення може взяти сусіднього союзника й висадити його біля кінцевої клітинки.",
  },
  riverBoatman: {
    name: "Човняр",
  ...
  riverTraLaLa: {
    name: "Тра-ля-ля",
    description:
      "За 4 заряди рухається по прямій, а союзники на шляху по одному разу атакують обраного ворога.",
  },
};

...
const abilitiesUk: Record<string, AbilityTranslation> = {
  ...
  duolingoPushNotification: { name: "Push-сповіщення", description: "Витратьте 3 Пропущені уроки й дію руху: перемістіться на вільну клітинку в радіусі 2 від обраної живої істоти." },
  ...
  zoroOniGiri: { name: "Оні Ґірі", description: "Власний лічильник отримує +1 на початку ходу Зоро. На 2 спрацьовує безкоштовна стартова версія. Під час ходу можна витратити 2 Рішучості, основну дію та рух. Перемістіться перед або за ворога на прямій і атакуйте лише його." },
  ...
  donKihoteMadness: { name: "Шалена омана", description: "Після смерті оберіть напрямок і востаннє атакуйте всіх ворогів на цій лінії з +1 шкоди." },
  ...
  artemidaSilverCrescent: { name: "Срібний місячний серп", description: "Витратьте 5 зарядів і дію. Атакуйте фігури на лінії та сусідніх клітинках; влучання завдає 2 шкоди." },

export const en = {
  ...
  actionMenu: {
    ...
    hidden: "Hidden",
    revealed: "Revealed",
    turnsHidden: "Turns hidden: {{current}}/{{max}}",
    stealthExpiryTiming: "Reveals at the start of this unit's {{turn}}th own turn.",
    falseTrailDurationExempt: "False Trail ignores the normal stealth duration limit.",
  ...
  pending: {
    ...
    context: {
      ...
      trapSave: "Trap Save",
      explosionSave: "Explosion Save",
      abilityRoll: "Ability Roll",
      phantasmRoll: "Phantasm Roll",
      reactionRoll: "Reaction Roll",
      tieBreak: "{{title}} Tie-break",
      youRollFor: "You are rolling for {{unit}}.",
      youRollControlled: "You are rolling for controlled {{unit}}.",
      yourRoll: "Your roll is required.",
      waitingForRoll: "Waiting for {{player}} to roll {{roll}} for {{unit}}.",
      waitingForSimpleRoll: "Waiting for {{player}} to roll {{roll}}.",
      ...
      failure: "Failure",
      against: "Against",
      againstAttackRoll: "{{source}}'s attack roll {{total}}",
      collapse: "Collapse",
      open: "Open",
      viewBattlefield: "View battlefield",
      rollDice: "Roll {{dice}}",
      rollShort: "Roll",
      hiddenUnit: "Hidden unit",
      unknownSource: "Unknown source",
      unknownTarget: "Unknown target",
      reasonAttack: "{{source}} attacks {{target}}.",
      reasonStealth: "{{actor}} tries to enter stealth.",
      reasonTrap: "{{target}} triggered {{source}}'s trap.",
      reasonExplosion: "Resolve the explosion effect.",
      reasonAbility: "{{actor}} uses {{ability}}{{target}}.",
      fallbackReason: "Roll dice to continue resolving the current effect.",
      thresholdSucceeds: "{{min}}-6 succeeds",
      rollHigherThan: "Roll higher than {{total}}",
      takeDamage: "Take {{damage}} damage.",
      attackSuccess: "Hit the target and resolve attack damage.",
      attackFailure: "The attack misses.",
      defenseSuccess: "Block or avoid the attack.",
      defenseFailure: "Take attack damage.",
      stealthSuccess: "The unit becomes hidden.",
      stealthFailure: "The unit remains revealed.",
      trapSuccess: "Avoid trap damage.",
      trapFailure: "Take 1 damage.",
      explosionSuccess: "Avoid or resolve the explosion successfully.",
      explosionFailure: "Take explosion damage.",
      genericSuccess: "Apply the successful effect.",
      genericFailure: "Apply the failed effect.",
    },
    ...
    donMadnessDirection:
      "Choose a direction for Don Kihote's final dash on the highlighted board rays.",
    ...
    papyrusBonePrompt:
      "Target {{current}} of {{total}}: {{target}}. Choose a bone effect for this hit.",
  ...
  board: {
    ...
    snare: "Snare",
    trapped: "Trapped",
    wrappedInSnares: "Wrapped in snares",

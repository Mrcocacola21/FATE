...
export const GENGHIS_KHAN_KHANS_DECREE_ID = "genghisKhanKhansDecree";
export const GENGHIS_KHAN_MONGOL_CHARGE_ID = "genghisKhanMongolCharge";
...
export const CHIKATILO_FALSE_TRAIL_ID = "chikatiloFalseTrail";
export const FALSE_TRAIL_EXPLOSION_ID = "falseTrailExplosion";
export const VLAD_STAKES_ID = "vladStakes";
export const VLAD_FOREST_ID = "vladForest";
...
export const GRIFFITH_FEMTO_REBIRTH_ID = "griffithFemtoRebirth";
export const FEMTO_DIVINE_MOVE_ID = "femtoDivineMove";
export const RIVER_PERSON_BOAT_ID = "riverBoat";

...
export const HERO_CATALOG: HeroCatalog = [
  ...
  { id: "jackRipper", name: "Jack the Ripper", mainClass: "assassin" },
  ...
  { id: "artemida", name: "Artemis", mainClass: "archer" },
  ...
  { id: "donKihote", name: "Don Quixote", mainClass: "rider" },
  ...
  { id: "zoro", name: "Zoro", mainClass: "knight" },

...
const markdownComponents: Components = {
  ...
  code: ({ inline, children }) =>
    inline ? (
      ...
      <code className="block whitespace-pre-wrap rounded bg-slate-100 p-3 text-[12px] text-slate-800">
        {children}
      </code>
    ),
};
      ...
      <div className="w-full max-w-3xl rounded border border-slate-200 bg-white shadow-xl">
        <div className="flex items-center justify-between border-b border-slate-200 px-6 py-4">
          <div>
            ...
            <h2 className="text-lg font-semibold text-slate-900">FATE Rules</h2>
          </div>
          <button
        ...
        <div className="max-h-[80vh] overflow-y-auto px-6 pb-6 pt-4 text-sm leading-relaxed text-slate-700">
